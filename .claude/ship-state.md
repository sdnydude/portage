...
phase4_progress:
  ...
  current: "T16 (Chunk 6 — frontend wiring, tdd-guard EXEMPT). T15 DONE (fb67686): bulkPublishOffers adapter method (POST /bulk_publish_offer, up to 25 per batch, per-offer success/failure) + /bulk/activate route publishes eBay drafts via batch API instead of skipping. DB updated per result. 1 adapter test + 1 route test. 344 pass, typecheck clean 3 ws. >>> CHUNK 5 (T13-T15) COMPLETE <<< Chunks remaining: 6 = T16-T18 (frontend), 7 = T19-T20 (Settings UI)."
