...
phase4_progress:
  ...
  current: "T18 (Chunk 6 — frontend, tdd-guard EXEMPT). T16+T17 DONE. T18 = inventory edit page quantity field. File: apps/web/src/app/inventory/[id]/edit/page.tsx. Add a quantity input bound to the item's quantity (items CRUD already accepts/returns quantity per T3); persist on save. Verify: dev server — edit → change quantity → save → reload → persisted. >>> CHUNK 6: T16+T17 DONE, T18 next <<< Chunks remaining: 6 = T18 (frontend), 7 = T19-T20 (Settings UI)."
