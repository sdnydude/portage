...
Vitest. Run `npm test` (once) or `npm run test:watch`. 704 tests across 69 files covering crypto, JWT, CF Access auth, admin, routes, vision, scan, billing, eBay CSV export, eBay messaging, Reverb adapter, and FAQs.
