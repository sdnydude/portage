      ...
      >
        ...
        <div className="flex items-center gap-1">
          ...
          <Link
            href="/more"
            aria-label="Settings"
            className="flex-shrink-0 w-11 h-11 rounded-full flex items-center justify-center text-[var(--text-secondary)] hover:bg-[var(--muted)] hover:text-[var(--text-primary)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--teal)]"
          >
