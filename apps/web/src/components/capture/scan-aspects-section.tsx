...
interface ScanAspectsSectionProps {
  ...
  /** Aspect names whose current value was auto-filled from the AI scan —
   *  rendered with an [AI] tag so the seller knows it's AI-provided (and editable). */
  aiFilledNames?: string[];
