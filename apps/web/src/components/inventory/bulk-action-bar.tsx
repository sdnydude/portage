      ...
      <div className="max-w-lg mx-auto rounded-2xl border border-border bg-surface/95 backdrop-blur-md shadow-lg overflow-hidden">
        ...
        <div className="flex items-center gap-2 px-3 py-2.5">
          ...
          <button
            ...
            disabled={isLoading}
            className="flex-1 flex flex-col items-center gap-1 py-2 rounded-xl bg-amber-50 dark:bg-amber-950/30 text-amber-700 dark:text-amber-400 disabled:opacity-50 active:scale-95 transition-transform"
