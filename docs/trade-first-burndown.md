...
| 2.6 | H — Orders sync (broken weeks) | ⬜ | 1.10 | Orders haven't synced; cause unconfirmed (token / no schedule / swallowed error) | recent orders appear after sync; scheduled + manual + visible errors | med |
